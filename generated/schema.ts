...
export class ERC721Contract extends Entity {
  ...
  get isEnumerable(): boolean {
    let value = this.get("isEnumerable");
    return value!.toBoolean();
  }

  set isEnumerable(value: boolean) {
    this.set("isEnumerable", Value.fromBoolean(value));
  }
...
export class ERC721Metadata extends Entity {
  constructor(id: string) {
    super();
    this.set("id", Value.fromString(id));
  }
  ...
  save(): void {
    let id = this.get("id");
    assert(id != null, "Cannot save ERC721Metadata entity without an ID");
    if (id) {
      assert(
        id.kind == ValueKind.STRING,
        `Entities of type ERC721Metadata must have an ID of type String but the id '${id.displayData()}' is of type ${id.displayKind()}`
      );
      store.set("ERC721Metadata", id.toString(), this);
    }
  }

  static load(id: string): ERC721Metadata | null {
    return changetype<ERC721Metadata | null>(store.get("ERC721Metadata", id));
  }
  ...
  get metadataIndex(): string {
    let value = this.get("metadataIndex");
    return value!.toString();
  }

  set metadataIndex(value: string) {
    this.set("metadataIndex", Value.fromString(value));
  }
  ...
  get external_uri(): string {
    let value = this.get("external_uri");
    return value!.toString();
  }

  set external_uri(value: string) {
    this.set("external_uri", Value.fromString(value));
  }
...
export class ERC721Attribute extends Entity {
  constructor(id: string) {
    super();
    this.set("id", Value.fromString(id));
  }
  ...
  save(): void {
    let id = this.get("id");
    assert(id != null, "Cannot save ERC721Attribute entity without an ID");
    if (id) {
      assert(
        id.kind == ValueKind.STRING,
        `Entities of type ERC721Attribute must have an ID of type String but the id '${id.displayData()}' is of type ${id.displayKind()}`
      );
      store.set("ERC721Attribute", id.toString(), this);
    }
  }

  static load(id: string): ERC721Attribute | null {
    return changetype<ERC721Attribute | null>(store.get("ERC721Attribute", id));
  }
