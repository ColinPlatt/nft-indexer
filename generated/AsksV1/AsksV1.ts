...
export class AsksV1ExchangeExecuted extends ethereum.Event {
  get params(): AsksV1ExchangeExecuted__Params {
    return new AsksV1ExchangeExecuted__Params(this);
  }
}

export class AsksV1ExchangeExecuted__Params {
  _event: AsksV1ExchangeExecuted;

  constructor(event: AsksV1ExchangeExecuted) {
    this._event = event;
  }
  ...
  get a(): AsksV1ExchangeExecutedAStruct {
    return changetype<AsksV1ExchangeExecutedAStruct>(
      this._event.parameters[2].value.toTuple()
    );
  }

  get b(): AsksV1ExchangeExecutedBStruct {
    return changetype<AsksV1ExchangeExecutedBStruct>(
      this._event.parameters[3].value.toTuple()
    );
  }
}

export class AsksV1ExchangeExecutedAStruct extends ethereum.Tuple {
  get tokenContract(): Address {
    return this[0].toAddress();
  }
...
export class AsksV1ExchangeExecutedBStruct extends ethereum.Tuple {
  get tokenContract(): Address {
    return this[0].toAddress();
  }
...
export class AsksV1RoyaltyPayout extends ethereum.Event {
  get params(): AsksV1RoyaltyPayout__Params {
    return new AsksV1RoyaltyPayout__Params(this);
  }
}

export class AsksV1RoyaltyPayout__Params {
  _event: AsksV1RoyaltyPayout;

  constructor(event: AsksV1RoyaltyPayout) {
    this._event = event;
  }
...
export class AsksV1__askForNFTResult {
  value0: Address;
  value1: Address;
  value2: Address;
  value3: i32;
...
export class AsksV1 extends ethereum.SmartContract {
  static bind(address: Address): AsksV1 {
    return new AsksV1("AsksV1", address);
  }

  askForNFT(param0: Address, param1: BigInt): AsksV1__askForNFTResult {
    ...
    return new AsksV1__askForNFTResult(
      result[0].toAddress(),
      result[1].toAddress(),
      result[2].toAddress(),
      result[3].toI32(),
  ...
  try_askForNFT(
    param0: Address,
    param1: BigInt
  ): ethereum.CallResult<AsksV1__askForNFTResult> {
